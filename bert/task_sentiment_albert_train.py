...
# albert-tiny
config_path = 'models/albert_tiny_zh_google/albert_config_tiny_g.json'
checkpoint_path = 'models/albert_tiny_zh_google/albert_model.ckpt'
dict_path = 'models/albert_tiny_zh_google/vocab.txt'
mode = 'albert'

# albert-base
# config_path = 'models/albert_base/albert_config.json'
# checkpoint_path = 'models/albert_base/model.ckpt-best'
# dict_path = 'models/albert_base/vocab_chinese.txt'
# mode = 'albert'
...
# 加载数据集
train_data = load_data('datasets/train_data.txt')
valid_data = load_data('datasets/train_data.txt')
test_data = load_data('datasets/test_data.txt')
